FFmpeg 9.0.1 Essentials Windows build
=====================================

Binary distributor: Gyan Doshi (gyan.dev)
...
Upstream release source: https://ffmpeg.org/releases/ffmpeg-9.0.1.tar.xz
Distributor build information: https://www.gyan.dev/ffmpeg/builds/
...
libraries. This short notice is not a replacement for those obligations.
